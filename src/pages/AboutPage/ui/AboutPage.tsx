...
const About = ({ aboutPage }: AboutPageProps) => {
  ...
  return (
    <motion.section
      ...
      className="section  lg:pt-[150px] pt-0 "
    >
        ...
        <div className="flex flex-col lg:flex-row h-full items-center justify-center gap-x-24 text-center lg:text-left lg:pt-16 ">
          {personImg && (
            <motion.div
              ...
              transition={transition1}
              className="absolute flex-1 max-h-96 lg:max-h-full order-2 lg:order-none overflow-hidden lg:relative lg:blur-none top-10%  left-50% lg:left-0 lg:w-[500px] lg:h-[500px] w-[60%] h-[60%] blur-sm pointer-events-none lg:pointer-events-auto"
            >
              <Image
          ...
          >
            ...
            <Link
              className="btn-fancy mb-[30px] hover:rounded-tr-lg hover:rounded-bl-lg hover:tracking-widest"
