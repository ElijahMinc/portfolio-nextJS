        ...
        <div className="flex flex-col lg:flex-row h-full items-center justify-center gap-x-24 text-center lg:text-left pt-24 lg:pt-36 pb-8">
          ...
          >
            ...
            <p className="mb-12 max-w-sm">
              ...
              error sit recusandae odio. Consequuntur animi, minima.
              <br />
              <br />
              aut ab quam consequatur adipisci dolore alias, sed iure fuga
              suscipit! Distinctio odit magnam laborum dolor facilis tempore
              totam, ut cupiditate obcaecati cumque recusandae quos voluptas
              reprehenderit.
            </p>
            <Link
